...
export {
    ...
    Block, BlockId, ControlledReadableStream, ControlledWritableStream, ControlledStreamPair, ControlledReadableEndpoint, ControlledWritableEndpoint, ObjectifiedControlledReadableEndpoint, ObjectifiedControlledWritableEndpoint, setUpdateControlledEndpointTimeout,
